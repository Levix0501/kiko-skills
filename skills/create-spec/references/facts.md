...
the user supplied; `verified` names what established the statement in the
writer's own session. A statement that is neither is not a fact. `bears on`
lists the decisions, R, or D whose meaning or readiness depends on the fact.
